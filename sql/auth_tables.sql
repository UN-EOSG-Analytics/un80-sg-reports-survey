...
CREATE INDEX IF NOT EXISTS idx_magic_tokens_cleanup ON sg_reports_survey.magic_tokens (expires_at) WHERE used_at IS NULL;
...
INSERT INTO sg_reports_survey.allowed_domains (entity, domain) VALUES
  -- UN Secretariat
  ('*', 'un.org'),
